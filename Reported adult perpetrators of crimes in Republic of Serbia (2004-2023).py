...
# Combined dataset for 2004–2023
data = {
...
# --- 1. Line Chart: Trends from 2004–2023 ---
fig_trend = go.Figure()
...
# --- 2. Bar Chart: Gender Participation (2004–2023) ---
fig_bar = go.Figure()
...
# --- 3. Pie Chart: Overall Gender Distribution (2004–2023) ---
# Aggregate male and female totals across the years
...
fig_pie = px.pie(
    ...
    title="Gender Distribution Among Known Adult Offenders in Serbia (2004–2023)",
    color="Gender",
